...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `employee_insert` AFTER INSERT ON `employee_salary` FOR EACH ROW BEGIN
...
-- Dump completed on 2025-10-20 23:44:10
